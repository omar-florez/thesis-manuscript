...
%	OTHER SETTINGS
%------------------------------------------------------------------------------
\input{inputs/listing_style_python}
...
{\normalsize July 2, 2018} % Current date
\end{center}
\end{titlepage}
...
\include{chapters/StackedDenoising}
\include{chapters/MutualCompetition}
...
\include{appendices/ImplementationDetails}
\include{appendices/DatasetDescription}
\include{appendices/PFPredictPackage}
\include{appendices/SupportVectorMachines}
