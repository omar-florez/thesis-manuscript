...
\documentclass[11pt,english,oneside,liststotoc,singlespacing,headsepline,chapterinoneline, consistentlayout]{style}
...
\thesistitle{
    ...
    %Feature Extraction using an Autoencoder with Mutual Competition
