...
% In the stacked-denoising autoencoder, describe this process as a bottom-up
% approach. We start from the network itself, then go up to the prediction
% pipeline etc.

\section{Mutually-Competitive Autoencoder}
\label{MCArchitecture}

Two operations form the core of the mutually-competitive autoencoder seen in
...
\begin{figure}[!h]
  \centering
  \includegraphics[width=0.8\textwidth]{ch04/schema_traintest}
